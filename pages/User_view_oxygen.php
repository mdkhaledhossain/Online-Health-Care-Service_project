...
<div class="fullbox">
        ...
        <div class="innerbox"> <div class="part3"> Emargency Oxygen Service</div> </div>
    </div>
    <br><hr><hr><br>
    ...
    <table border = "1" align = "center">
        <caption><div class = "table_header_1">Oxygen Info Table</div></caption>
        <thead>
          <tr>
            <th>ID</th>
            <th>Size</th>
        ...
        $view_oxygen_query = "SELECT * from oxygen";
        $run = mysqli_query($conn, $view_oxygen_query);
